...
class JellyfinHomeTheaterActionResponse[F[_]: Sync] extends HomeTheaterActionResponse("jellyfin")
...
object HomeTheaterIntentHandler extends IntentHandler {
  ...
  def activityDecode[F[_]: Sync](slotVal: String): HomeTheaterActionResponse[F] = {
    slotVal.toLowerCase() match {
      ...
      case "youtube" | "you tube" | "you too"        => new YoutubeHomeTheaterActionResponse()
      case "twitch"                                  => new TwitchHomeTheaterActionResponse()
      case "my movies" | "jellyfin" | "jelly fin"    => new JellyfinHomeTheaterActionResponse()
      case "jellyfish" | "jelly fish"                => new JellyfinHomeTheaterActionResponse()
      case "plex"                                    => new PlexHomeTheaterActionResponse()
